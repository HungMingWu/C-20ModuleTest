...
export module small.vector;

import small.traits;
import small.iterator;
import small.exception;
...
namespace small {
    ...
    public:
        ...
        using iterator = pointer_wrapper<pointer>;
        using const_iterator = pointer_wrapper<const_pointer>;
        using reverse_iterator = std::reverse_iterator<iterator>;
        using const_reverse_iterator = std::reverse_iterator<const_iterator>;

        static_assert(std::is_unsigned_v<size_t>, "Size type should be an unsigned integral type");
